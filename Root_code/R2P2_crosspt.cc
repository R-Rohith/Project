...
//  cout <<"R2P2B2_prc_v3: "<<ptCase;<<"\t"<<strMult<<"\t"<< strPt<<endl;
  ...
  */
  TH1D *h1d_n1_ptP1    = (TH1D*)ftpcorr->Get("r2p24id/h1d_n1_ptP1");
  TH1D *h1d_n1_ptM1    = (TH1D*)ftpcorr->Get("r2p24id/h1d_n1_ptM1");
  TH1D *h1d_n1_ptP2    = (TH1D*)ftpcorr->Get("r2p24id/h1d_n1_ptP2");
  TH1D *h1d_n1_ptM2    = (TH1D*)ftpcorr->Get("r2p24id/h1d_n1_ptM2");

  //----------R2----------------------------
  TH2D *h2d_n1_etaPhiP1             = (TH2D*)ftpcorr->Get("r2p24id/h2d_n1_etaPhiP1");
  TH2D *h2d_n1_etaPhiM1             = (TH2D*)ftpcorr->Get("r2p24id/h2d_n1_etaPhiM1");
  TH2D *h2d_n1_etaPhiP2             = (TH2D*)ftpcorr->Get("r2p24id/h2d_n1_etaPhiP2");
  TH2D *h2d_n1_etaPhiM2             = (TH2D*)ftpcorr->Get("r2p24id/h2d_n1_etaPhiM2");
  TH2D *h2d_n2_eta1Phi1Eta2Phi2PM12  = (TH2D*)ftpcorr->Get("r2p24id/h2d_n2_eta1Phi1Eta2Phi2PM12");
  TH2D *h2d_n2_eta1Phi1Eta2Phi2PM21  = (TH2D*)ftpcorr->Get("r2p24id/h2d_n2_eta1Phi1Eta2Phi2PM21");
  ...
  //--------------------DpTDpT---------------------
  TH2D *h2d_pt_etaPhiP1               = (TH2D*)ftpcorr->Get("r2p24id/h2d_pt_etaPhiP1");
  TH2D *h2d_pt_etaPhiM1               = (TH2D*)ftpcorr->Get("r2p24id/h2d_pt_etaPhiM1");
  TH2D *h2d_pt_etaPhiP2               = (TH2D*)ftpcorr->Get("r2p24id/h2d_pt_etaPhiP2");
  TH2D *h2d_pt_etaPhiM2               = (TH2D*)ftpcorr->Get("r2p24id/h2d_pt_etaPhiM2");
  TH2D *h2d_ptpt_eta1Phi1Eta2Phi2PM12  = (TH2D*)ftpcorr->Get("r2p24id/h2d_ptpt_eta1Phi1Eta2Phi2PM12");
  TH2D *h2d_ptpt_eta1Phi1Eta2Phi2PM21  = (TH2D*)ftpcorr->Get("r2p24id/h2d_ptpt_eta1Phi1Eta2Phi2PM21");
  ...
  TH2D *h2d_ptn_eta1Phi1Eta2Phi2PM12   = (TH2D*)ftpcorr->Get("r2p24id/h2d_ptn_eta1Phi1Eta2Phi2PM12");
  TH2D *h2d_ptn_eta1Phi1Eta2Phi2PM21   = (TH2D*)ftpcorr->Get("r2p24id/h2d_ptn_eta1Phi1Eta2Phi2PM21");
  ...
  TH2D *h2d_npt_eta1Phi1Eta2Phi2PM12   = (TH2D*)ftpcorr->Get("r2p24id/h2d_npt_eta1Phi1Eta2Phi2PM12");
  TH2D *h2d_npt_eta1Phi1Eta2Phi2PM21   = (TH2D*)ftpcorr->Get("r2p24id/h2d_npt_eta1Phi1Eta2Phi2PM21");
  ...
  const Int_t knetabins     = h2d_n1_etaPhiP1->GetNbinsX() ;
  const Int_t knphibins     = h2d_n1_etaPhiP1->GetNbinsY() ;

  const Int_t nBins_ShiftY  = knphibins / 4.0;
  //cout << "\v \v nBins_Dphi_shft \v \v" << nBins_ShiftY << endl;


  Double_t deta             = h2d_n1_etaPhiP1->GetXaxis()->GetBinWidth(0);
  Double_t deta2            = TMath::Power(deta, 2);
  Double_t dphi             = h2d_n1_etaPhiP1->GetYaxis()->GetBinWidth(0);
  ...
  //-------------------Histogram Booking----------------------
  //-----------------R2-----------------------------------------
  TH2D *h2d_n1n1_eta1Phi1Eta2Phi2PM12
    = new TH2D("h2d_n1n1_eta1Phi1Eta2Phi2PM12",
               "h2d_n1n1_eta1Phi1Eta2Phi2PM12",
               knetaphibinsx, kminetaphi, kmaxetaphi,
               knetaphibinsy, kminetaphi, kmaxetaphi);
  TH2D *h2d_n1n1_eta1Phi1Eta2Phi2PM21
    = new TH2D("h2d_n1n1_eta1Phi1Eta2Phi2PM21",
               "h2d_n1n1_eta1Phi1Eta2Phi2PM21",
               knetaphibinsx, kminetaphi, kmaxetaphi,
               knetaphibinsy, kminetaphi, kmaxetaphi);
  ...
  TH2D *h2d_r2_eta1Phi1Eta2Phi2PM12
    = new TH2D("h2d_r2_eta1Phi1Eta2Phi2PM12",
               "h2d_r2_eta1Phi1Eta2Phi2PM12",
               knetaphibinsx, kminetaphi, kmaxetaphi,
               knetaphibinsy, kminetaphi, kmaxetaphi);
  TH2D *h2d_r2_eta1Phi1Eta2Phi2PM21
    = new TH2D("h2d_r2_eta1Phi1Eta2Phi2PM21",
               "h2d_r2_eta1Phi1Eta2Phi2PM21",
               knetaphibinsx, kminetaphi, kmaxetaphi,
               knetaphibinsy, kminetaphi, kmaxetaphi);
  ...
  TH2D *h2d_n1n1_DetaDphiPM12
    = new TH2D("h2d_n1n1_DetaDphiPM12",
               "h2d_n1n1_DetaDphiPM12",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  TH2D *h2d_n1n1_DetaDphiPM21
    = new TH2D("h2d_n1n1_DetaDphiPM21",
               "h2d_n1n1_DetaDphiPM21",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  ...
  TH2D *h2d_n2_DetaDphiPM12
    = new TH2D("h2d_n2_DetaDphiPM12",
               "h2d_n2_DetaDphiPM12",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  TH2D *h2d_n2_DetaDphiPM21
    = new TH2D("h2d_n2_DetaDphiPM21",
               "h2d_n2_DetaDphiPM21",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  ...
  TH2D *h2d_r2_DetaDphiPM12
    = new TH2D("h2d_r2_DetaDphiPM12",
               "h2d_r2_DetaDphiPM12",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  TH2D *h2d_r2_DetaDphiPM21
    = new TH2D("h2d_r2_DetaDphiPM21",
               "h2d_r2_DetaDphiPM21",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  ...
  TH2D *h2d_n1n1_DetaDphiPM12_ShiftY
    = new TH2D("h2d_n1n1_DetaDphiPM12_ShiftY",
               "h2d_n1n1_DetaDphiPM12_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  TH2D *h2d_n1n1_DetaDphiPM21_ShiftY
    = new TH2D("h2d_n1n1_DetaDphiPM21_ShiftY",
               "h2d_n1n1_DetaDphiPM21_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  ...
  TH2D *h2d_n2_DetaDphiPM12_ShiftY
    = new TH2D("h2d_n2_DetaDphiPM12_ShiftY",
               "h2d_n2_DetaDphiPM12_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  TH2D *h2d_n2_DetaDphiPM21_ShiftY
    = new TH2D("h2d_n2_DetaDphiPM21_ShiftY",
               "h2d_n2_DetaDphiPM21_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  ...
  TH2D *h2d_r2_DetaDphiPM12_ShiftY
    = new TH2D("h2d_r2_DetaDphiPM12_ShiftY",
               "h2d_r2_DetaDphiPM12_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  TH2D *h2d_r2_DetaDphiPM21_ShiftY
    = new TH2D("h2d_r2_DetaDphiPM21_ShiftY",
               "h2d_r2_DetaDphiPM21_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  TH2D *h2d_r2_DetaDphiPP_ShiftY
    = new TH2D("h2d_r2_DetaDphiPP_ShiftY",
               "h2d_r2_DetaDphiPP_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  TH2D *h2d_r2_DetaDphiMM_ShiftY
    = new TH2D("h2d_r2_DetaDphiMM_ShiftY",
               "h2d_r2_DetaDphiMM_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  ...
  TH2D *h2d_pt1pt1_eta1Phi1Eta2Phi2PM12
    = new TH2D("h2d_pt1pt1_eta1Phi1Eta2Phi2PM12",
               "h2d_pt1pt1_eta1Phi1Eta2Phi2PM12",
               knetaphibinsx, kminetaphi, kmaxetaphi,
               knetaphibinsy, kminetaphi, kmaxetaphi);
  TH2D *h2d_pt1pt1_eta1Phi1Eta2Phi2PM21
    = new TH2D("h2d_pt1pt1_eta1Phi1Eta2Phi2PM21",
               "h2d_pt1pt1_eta1Phi1Eta2Phi2PM21",
               knetaphibinsx, kminetaphi, kmaxetaphi,
               knetaphibinsy, kminetaphi, kmaxetaphi);
  ...
  TH2D *h2d_DptDpt_eta1Phi1Eta2Phi2PM12
    = new TH2D("h2d_DptDpt_eta1Phi1Eta2Phi2PM12",
               "h2d_DptDpt_eta1Phi1Eta2Phi2PM12",
               knetaphibinsx, kminetaphi, kmaxetaphi,
               knetaphibinsy, kminetaphi, kmaxetaphi);
  TH2D *h2d_DptDpt_eta1Phi1Eta2Phi2PM21
    = new TH2D("h2d_DptDpt_eta1Phi1Eta2Phi2PM21",
               "h2d_DptDpt_eta1Phi1Eta2Phi2PM21",
               knetaphibinsx, kminetaphi, kmaxetaphi,
               knetaphibinsy, kminetaphi, kmaxetaphi);
  ...
  TH2D *h2d_p2DptDpt_eta1Phi1Eta2Phi2PM12
    = new TH2D("h2d_p2DptDpt_eta1Phi1Eta2Phi2PM12",
               "h2d_p2DptDpt_eta1Phi1Eta2Phi2PM12",
               knetaphibinsx, kminetaphi, kmaxetaphi,
               knetaphibinsy, kminetaphi, kmaxetaphi);
  TH2D *h2d_p2DptDpt_eta1Phi1Eta2Phi2PM21
    = new TH2D("h2d_p2DptDpt_eta1Phi1Eta2Phi2PM21",
               "h2d_p2DptDpt_eta1Phi1Eta2Phi2PM21",
               knetaphibinsx, kminetaphi, kmaxetaphi,
               knetaphibinsy, kminetaphi, kmaxetaphi);
  TH2D *h2d_p2DptDpt_eta1Phi1Eta2Phi2PP
    = new TH2D("h2d_p2DptDpt_eta1Phi1Eta2Phi2PP",
               "h2d_p2DptDpt_eta1Phi1Eta2Phi2PP",
               knetaphibinsx, kminetaphi, kmaxetaphi,
               knetaphibinsy, kminetaphi, kmaxetaphi);
  TH2D *h2d_p2DptDpt_eta1Phi1Eta2Phi2MM
    = new TH2D("h2d_p2DptDpt_eta1Phi1Eta2Phi2MM",
               "h2d_p2DptDpt_eta1Phi1Eta2Phi2MM",
               knetaphibinsx, kminetaphi, kmaxetaphi,
               knetaphibinsy, kminetaphi, kmaxetaphi);

  TH2D *h2d_pt1pt1_DetaDphiPM12
    = new TH2D("h2d_pt1pt1_DetaDphiPM12",
               "h2d_pt1pt1_DetaDphiPM12",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  TH2D *h2d_pt1pt1_DetaDphiPM21
    = new TH2D("h2d_pt1pt1_DetaDphiPM21",
               "h2d_pt1pt1_DetaDphiPM21",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  ...
  TH2D *h2d_ptpt_DetaDphiPM12
    = new TH2D("h2d_ptpt_DetaDphiPM12",
               "h2d_ptpt_DetaDphiPM12",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  TH2D *h2d_ptpt_DetaDphiPM21
    = new TH2D("h2d_ptpt_DetaDphiPM21",
               "h2d_ptpt_DetaDphiPM21",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  ...
  TH2D *h2d_ptn_DetaDphiPM12
    = new TH2D("h2d_ptn_DetaDphiPM12",
               "h2d_ptn_DetaDphiPM12",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  TH2D *h2d_ptn_DetaDphiPM21
    = new TH2D("h2d_ptn_DetaDphiPM21",
               "h2d_ptn_DetaDphiPM21",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  ...
  TH2D *h2d_npt_DetaDphiPM12
    = new TH2D("h2d_npt_DetaDphiPM12",
               "h2d_npt_DetaDphiPM12",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  TH2D *h2d_npt_DetaDphiPM21
    = new TH2D("h2d_npt_DetaDphiPM21",
               "h2d_npt_DetaDphiPM21",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  ...
  TH2D *h2d_DptDpt_DetaDphiPM12
    = new TH2D("h2d_DptDpt_DetaDphiPM12",
               "h2d_DptDpt_DetaDphiPM12",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  TH2D *h2d_DptDpt_DetaDphiPM21
    = new TH2D("h2d_DptDpt_DetaDphiPM21",
               "h2d_DptDpt_DetaDphiPM21",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  ...
  TH2D *h2d_DptDpt_DetaDphiPM12_ShiftY
    = new TH2D("h2d_DptDpt_DetaDphiPM12_ShiftY",
               "h2d_DptDpt_DetaDphiPM12_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  TH2D *h2d_DptDpt_DetaDphiPM21_ShiftY
    = new TH2D("h2d_DptDpt_DetaDphiPM21_ShiftY",
               "h2d_DptDpt_DetaDphiPM21_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  TH2D *h2d_DptDpt_DetaDphiPP_ShiftY
    = new TH2D("h2d_DptDpt_DetaDphiPP_ShiftY",
               "h2d_DptDpt_DetaDphiPP_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  TH2D *h2d_DptDpt_DetaDphiMM_ShiftY
    = new TH2D("h2d_DptDpt_DetaDphiMM_ShiftY",
               "h2d_DptDpt_DetaDphiMM_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());

  TH2D *h2d_DptDptCI_DetaDphi
    = new TH2D("h2d_DptDptCI_DetaDphi",
               "h2d_DptDptCI_DetaDphi",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  TH2D *h2d_DptDptCD_DetaDphi
    = new TH2D("h2d_DptDptCD_DetaDphi",
               "h2d_DptDptCD_DetaDphi",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());

  TH2D *h2d_B2DptDpt_DetaDphi
    = new TH2D("h2d_B2DptDpt_DetaDphi",
               "h2d_B2DptDpt_DetaDphi",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());

  TH2D *h2d_p2DptDpt_DetaDphiPM12
    = new TH2D("h2d_p2DptDpt_DetaDphiPM12",
               "h2d_p2DptDpt_DetaDphiPM12",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());
  TH2D *h2d_p2DptDpt_DetaDphiPM21
    = new TH2D("h2d_p2DptDpt_DetaDphiPM21",
               "h2d_p2DptDpt_DetaDphiPM21",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());

  TH2D *h2d_p2DptDpt_DetaDphiPP
    = new TH2D("h2d_p2DptDpt_DetaDphiPP",
               "h2d_p2DptDpt_DetaDphiPP",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());

  TH2D *h2d_p2DptDpt_DetaDphiMM
    = new TH2D("h2d_p2DptDpt_DetaDphiMM",
               "h2d_p2DptDpt_DetaDphiMM",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, 0., 2.*TMath::Pi());

  TH2D *h2d_p2DptDpt_DetaDphiPM12_ShiftY
    = new TH2D("h2d_p2DptDpt_DetaDphiPM12_ShiftY",
               "h2d_p2DptDpt_DetaDphiPM12_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  TH2D *h2d_p2DptDpt_DetaDphiPM21_ShiftY
    = new TH2D("h2d_p2DptDpt_DetaDphiPM21_ShiftY",
               "h2d_p2DptDpt_DetaDphiPM21_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  TH2D *h2d_p2DptDpt_DetaDphiPP_ShiftY
    = new TH2D("h2d_p2DptDpt_DetaDphiPP_ShiftY",
               "h2d_p2DptDpt_DetaDphiPP_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  TH2D *h2d_p2DptDpt_DetaDphiMM_ShiftY
    = new TH2D("h2d_p2DptDpt_DetaDphiMM_ShiftY",
               "h2d_p2DptDpt_DetaDphiMM_ShiftY",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
  ...
  TH2D *h2d_DptDpt_DetaDphiUS
    = new TH2D("h2d_DptDpt_DetaDphiUS",
               "h2d_DptDpt_DetaDphiUS",
               nBins_Deta, kmindeta, kmaxdeta,
               knphibins, -(0.5+1.0/36.0) * TMath::Pi(), (1.5-1.0/36.0) * TMath::Pi());
...
TH1I *h1i_n1_multPM = (TH1I*)ftpcorr->Get("r2p24id/h1i_n1_multPM");
	...
	Normalize2D(h2d_n1_etaPhiP1, scale, dphi, deta);
...
//-----------------_______________________________--------------------------------------___________________--------------------
  ...
  h2d_n1n1_eta1Phi1Eta2Phi2PM12->Sumw2();
  h2d_n1n1_eta1Phi1Eta2Phi2PM21->Sumw2();
  h2d_n1n1_eta1Phi1Eta2Phi2PP->Sumw2();
  h2d_n1n1_eta1Phi1Eta2Phi2MM->Sumw2();
  h2d_n1n1_DetaDphiPM12->Sumw2();
  h2d_n1n1_DetaDphiPM21->Sumw2();
  h2d_n1n1_DetaDphiPP->Sumw2();
  h2d_n1n1_DetaDphiMM->Sumw2();
  h2d_n2_DetaDphiPM12->Sumw2();
  h2d_n2_DetaDphiPM21->Sumw2();
  h2d_n2_DetaDphiPP->Sumw2();
  h2d_n2_DetaDphiMM->Sumw2();
  h2d_r2_eta1Phi1Eta2Phi2PM12->Sumw2();
  h2d_r2_eta1Phi1Eta2Phi2PM21->Sumw2();
  ...
  //-----------------DpTDpT----------------------
  h2d_pt1pt1_eta1Phi1Eta2Phi2PM12->Sumw2();
  h2d_pt1pt1_eta1Phi1Eta2Phi2PM21->Sumw2();
  h2d_pt1pt1_eta1Phi1Eta2Phi2PP->Sumw2();
  h2d_pt1pt1_eta1Phi1Eta2Phi2MM->Sumw2();
  h2d_DptDpt_eta1Phi1Eta2Phi2PM12->Sumw2();
  h2d_DptDpt_eta1Phi1Eta2Phi2PM21->Sumw2();
  h2d_DptDpt_eta1Phi1Eta2Phi2PP->Sumw2();
  h2d_DptDpt_eta1Phi1Eta2Phi2MM->Sumw2();
  h2d_p2DptDpt_eta1Phi1Eta2Phi2PM12->Sumw2();
  h2d_p2DptDpt_eta1Phi1Eta2Phi2PM21->Sumw2();
  h2d_p2DptDpt_eta1Phi1Eta2Phi2PP->Sumw2();
  h2d_p2DptDpt_eta1Phi1Eta2Phi2MM->Sumw2();
  h2d_pt1pt1_DetaDphiPM12->Sumw2();
  h2d_pt1pt1_DetaDphiPM21->Sumw2();
  h2d_pt1pt1_DetaDphiPP->Sumw2();
  h2d_pt1pt1_DetaDphiMM->Sumw2();
  h2d_ptn_DetaDphiPM12->Sumw2();
  h2d_ptn_DetaDphiPM21->Sumw2();
  h2d_ptn_DetaDphiPP->Sumw2();
  h2d_ptn_DetaDphiMM->Sumw2();
  h2d_npt_DetaDphiPM12->Sumw2();
  h2d_npt_DetaDphiPM21->Sumw2();
  h2d_npt_DetaDphiPP->Sumw2();
  h2d_npt_DetaDphiMM->Sumw2();
  h2d_DptDpt_DetaDphiPM12->Sumw2();
  h2d_DptDpt_DetaDphiPM21->Sumw2();
  h2d_DptDpt_DetaDphiPP->Sumw2();
  h2d_DptDpt_DetaDphiMM->Sumw2();
  h2d_DptDpt_DetaDphiPM12_ShiftY->Sumw2();
  h2d_DptDpt_DetaDphiPM21_ShiftY->Sumw2();
  h2d_DptDpt_DetaDphiPP_ShiftY->Sumw2();
  h2d_DptDpt_DetaDphiMM_ShiftY->Sumw2();
  h2d_p2DptDpt_DetaDphiPM12->Sumw2();
  h2d_p2DptDpt_DetaDphiPM21->Sumw2();
 ...
 //product of single particle density
  //---------------R2---------------------------------
  Rho1Rho1EtaPhi(h2d_n1_etaPhiP1, h2d_n1_etaPhiM2, h2d_n1n1_eta1Phi1Eta2Phi2PM12);
  Rho1Rho1EtaPhi(h2d_n1_etaPhiP2, h2d_n1_etaPhiM1, h2d_n1n1_eta1Phi1Eta2Phi2PM21);
  Rho1Rho1EtaPhi(h2d_n1_etaPhiP1, h2d_n1_etaPhiP2, h2d_n1n1_eta1Phi1Eta2Phi2PP);
  Rho1Rho1EtaPhi(h2d_n1_etaPhiM1, h2d_n1_etaPhiM2, h2d_n1n1_eta1Phi1Eta2Phi2MM);
...
/*
  ...
  EtaPhiTodEtadPhi(h2d_n2_eta1Phi1Eta2Phi2MM, h2d_n2_DetaDphiMM,
                   knetabins,  knphibins);
*/
  EtaPhiTodEtadPhi(h2d_r2_eta1Phi1Eta2Phi2PM12, h2d_r2_DetaDphiPM12,
                   knetabins,  knphibins);
  EtaPhiTodEtadPhi(h2d_r2_eta1Phi1Eta2Phi2PM21, h2d_r2_DetaDphiPM21,
                   knetabins,  knphibins);
...
/*  EtaPhiTodEtadPhi(h2d_ptpt_eta1Phi1Eta2Phi2PM, h2d_ptpt_DetaDphiPM,
  ...
  EtaPhiTodEtadPhi(h2d_pt1pt1_eta1Phi1Eta2Phi2MM, h2d_pt1pt1_DetaDphiMM,
                   knetabins,  knphibins);					*/
  EtaPhiTodEtadPhi(h2d_DptDpt_eta1Phi1Eta2Phi2PM12, h2d_DptDpt_DetaDphiPM12,
                   knetabins,  knphibins);
  EtaPhiTodEtadPhi(h2d_DptDpt_eta1Phi1Eta2Phi2PM21, h2d_DptDpt_DetaDphiPM21,
                   knetabins,  knphibins);
  ...
  EtaPhiTodEtadPhi(h2d_p2DptDpt_eta1Phi1Eta2Phi2PM12, h2d_p2DptDpt_DetaDphiPM12,
                   knetabins,  knphibins);
  EtaPhiTodEtadPhi(h2d_p2DptDpt_eta1Phi1Eta2Phi2PM21, h2d_p2DptDpt_DetaDphiPM21,
                   knetabins,  knphibins);
  ...
  SymmetrizeDEtaDPhi(h2d_r2_DetaDphiPM12);
  SymmetrizeDEtaDPhi(h2d_r2_DetaDphiPM21);
  ...
  SymmetrizeDEtaDPhi(h2d_DptDpt_DetaDphiPM12);
  SymmetrizeDEtaDPhi(h2d_DptDpt_DetaDphiPM21);
  SymmetrizeDEtaDPhi(h2d_DptDpt_DetaDphiPP);
  SymmetrizeDEtaDPhi(h2d_DptDpt_DetaDphiMM);
  SymmetrizeDEtaDPhi(h2d_p2DptDpt_DetaDphiPM12);
  SymmetrizeDEtaDPhi(h2d_p2DptDpt_DetaDphiPM21);
  SymmetrizeDEtaDPhi(h2d_p2DptDpt_DetaDphiPP);
  SymmetrizeDEtaDPhi(h2d_p2DptDpt_DetaDphiMM);

  //Shiftting starts
  //----------------R2---------------------------------
  shiftY(*h2d_r2_DetaDphiPM12,   *h2d_r2_DetaDphiPM12_ShiftY, nBins_ShiftY);
  shiftY(*h2d_r2_DetaDphiPM21,   *h2d_r2_DetaDphiPM21_ShiftY, nBins_ShiftY);
  ...
  h2d_r2_DetaDphiUS->Add(h2d_r2_DetaDphiPM12_ShiftY, h2d_r2_DetaDphiPM21_ShiftY, .5, .5);

  //-------------------DpTDpT----------------------

  shiftY(*h2d_DptDpt_DetaDphiPM12,   *h2d_DptDpt_DetaDphiPM12_ShiftY, nBins_ShiftY);
  shiftY(*h2d_DptDpt_DetaDphiPM21,   *h2d_DptDpt_DetaDphiPM21_ShiftY, nBins_ShiftY);
  ...
  shiftY(*h2d_p2DptDpt_DetaDphiPM12,   *h2d_p2DptDpt_DetaDphiPM12_ShiftY, nBins_ShiftY);
  shiftY(*h2d_p2DptDpt_DetaDphiPM21,   *h2d_p2DptDpt_DetaDphiPM21_ShiftY, nBins_ShiftY);
  ...
  h2d_p2DptDpt_DetaDphiUS->Add(h2d_p2DptDpt_DetaDphiPM12_ShiftY, h2d_p2DptDpt_DetaDphiPM21_ShiftY, .5, .5);
  h2d_DptDpt_DetaDphiUS->Add(h2d_DptDpt_DetaDphiPM12_ShiftY, h2d_DptDpt_DetaDphiPM21_ShiftY, .5, .5);

  //-------------calculate CI  -------------------
  //R2ci = (2*R2pm + R2pp + R2mm)/4.; or (0.5*R2pm + 0.25*R2pp + 0.25*R2mm)
  //-----------R2------------------------
  calculate_CI_CD(h2d_r2_DetaDphiUS, h2d_r2_DetaDphiPP_ShiftY, h2d_r2_DetaDphiMM_ShiftY, h2d_r2CI_DetaDphi, h2d_r2CD_DetaDphi);

  //---------------DpTDpT----------------

  calculate_CI_CD(h2d_DptDpt_DetaDphiUS, h2d_DptDpt_DetaDphiPP_ShiftY,
                  h2d_DptDpt_DetaDphiMM_ShiftY, h2d_DptDptCI_DetaDphi, h2d_DptDptCD_DetaDphi);
  //---------------p2DpTDpT----------------

  calculate_CI_CD(h2d_p2DptDpt_DetaDphiUS, h2d_p2DptDpt_DetaDphiPP_ShiftY,
...
smoothFunXRebinY(h2d_p2DptDptCD_DetaDphi, h2d_p2DptDptCD_DetaDphiRebined);
  ...
  //-------------calculate B2 -------------------
  //-----------R2------------------------
  //cout << "h2d_B2_DetaDphi Starts " << endl;					//Need to check B2
//  calculate_B2(h2d_n1_etaPhiP, h2d_n1_etaPhiM,               h2d_r2CD_DetaDphi, h2d_B2_DetaDphi);
  //cout << "h2d_B2_DetaDphi Ends " << endl;
  //---------------DpTDpT----------------
//  calculate_B2(h2d_pt_etaPhiP, h2d_pt_etaPhiM,               h2d_DptDptCD_DetaDphi, h2d_B2DptDpt_DetaDphi);

  //---------------p2DpTDpT----------------
//  calculate_B2(h2d_pt_etaPhiP, h2d_pt_etaPhiM,               h2d_p2DptDptCD_DetaDphi, h2d_B2p2DptDpt_DetaDphi);
...
void CalculateR2(const TH2D * n2_12, const TH2D * n1n1_12, TH2D * r2_12)
{
  ...
  for ( i_x = 1; i_x <= n2_12_n_x; ++i_x)
  {
    for ( i_y = 1; i_y <= n2_12_n_y; ++i_y)
    {
      ...
      {
        v   = v1 / v2;v*=2.; // all pairs counted - no need to multiply by 2
        re1 = ev1 / v1;
        re2 = ev2 / v2;
      ...
      for (Int_t iEta2 = 0; iEta2 < nEta; ++iEta2)
      {
        ...
        for (Int_t iPhi2 = 0; iPhi2 < nPhi; ++iPhi2)
        {
          ...
          if (v4 != 0 ) // && ev4/v4<0.5)
          {
            ...
            v7 = (v6 / (p1 * p2));			//Ok so doing this does give the desired plot...although is it legal. Yes it is!
            ev7 = ev6 / (p1 * p2);
          }
          else
          {
