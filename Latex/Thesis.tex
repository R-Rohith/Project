...
\vspace*{1in}
I would like to thank my P.I. Dr. Sadhana Dash, for allowing me the opportunity to work with her at IIT Bombay, and her constant support during the duration of my thesis project. I would like to thank my PhD bhaiyas and didis at IIT Bombay: Yash Patley, Tanu Gahlaut, Rahul Verma, and Sonali Padhan; for their help, advice and guidance in my thesis work. Above all, I would like to thank my parents for their never-ending support and their belief in me to pursue a career in science. I would also like to thank my friends, the best people I have come across in the world, for always being there for me, in my lowest lows and the highest highs. These five years of college would have been miserable if not for them. I'm proud to be a part of the MY\_RUNS group.

\newpage
\begin{abstract}
	\thispagestyle{plain}
	\setcounter{page}{4}
	Two particle correlations are one of the many tools that have been used to understand the underlying physics mechanisms of high-energy collisions. They have been used previously to detect flow and jet quenching, thus pointing to the presence of QGP. This analysis aims to study R2 \& P2 correlations of identified particles in p-p collisions, to better understand the particle production mechanisms. These correlators were chosen as they are independent of detector efficiency. The analysis has two main steps: identifying particles and calculating R2 \& P2 correlations for each species pair. The TPC and TOF detectors were used to identify the particles by defining $p_T$ dependent $N\sigma$ cuts for each particle species. The efficiency and purity in identifying particles were calculated. After particle identification R2 \& P2 correlators for unlike-sign, like-sign, charge-independent, and charge dependent of $\pi$-$\pi$, K-K, p-p, $\pi$-K, $\pi$-p, and p-K particle pairs were calculated. Analysing the correlations revealed details on the influence of charge and momentum conservations on the production of the different particle species pairs.
\end{abstract}
\newpage
\tableofcontents
\newpage
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{./Images/Jetq.pdf}
