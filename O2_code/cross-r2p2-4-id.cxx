...
template <typename T> bool NO_PID(T track)
{
	return true;
}
...
//template <typename T> using (*(PID_Array)) (T track) = bool;
//typedef bool (*PID_Array)();
template <typename T> bool (*pidarray[4])(T)={NO_PID,PID_PION,PID_KAON,PID_PROTON};

template <typename H> void CommonInit(H & histos)
{
	//-----Defining Histograms------------------------------------------------
...
template <typename TrackTable,typename Histograms> void CommonProcess(TrackTable tracks, Histograms &histos,int p1, int p2)
{
	bool flag;
...
//    PID_Array pidarray[4]={NO_PID,PID_PION,PID_KAON,PID_PROTON};
	for (auto track1 : tracks) {
      ...
      if(!pidarray<decltype(track1)>[p1](track1))continue;
      ...
      for (auto track2 : tracks) {
        ...
        //-----KAON PID Particle 2------------------------------------------------
        if(!pidarray<decltype(track1)>[p2](track2))continue;
        //------------------------------------------------------------------------
...
struct r2p24ch {
  ...
  Filter ptfilter = aod::track::pt > 1.0f && aod::track::pt < 2.0f;
  ...
  {
	  CommonProcess(tracks,histos,0,0);
  }
};
...
struct r2p24pi {
  ...
  void process(soa::Filtered<soa::Join<aod::Collisions, aod::EvSels>>::iterator const& filteredCollisions, soa::Filtered<soa::Join<aod::Tracks, aod::TrackSelection, aod::pidTPCPi, aod::pidTOFPi, aod::pidTPCPr, aod::pidTOFPr, aod::pidTPCKa, aod::pidTOFKa, aod::pidTPCEl, aod::pidTOFbeta, aod::TracksExtra>> const& tracks)
  {
	  CommonProcess(tracks,histos,1,1);
  }
};
...
struct r2p24ka {
  ...
  void process(soa::Filtered<soa::Join<aod::Collisions, aod::EvSels>>::iterator const& filteredCollisions, soa::Filtered<soa::Join<aod::Tracks, aod::TrackSelection, aod::pidTPCPi, aod::pidTOFPi, aod::pidTPCPr, aod::pidTOFPr, aod::pidTPCKa, aod::pidTOFKa, aod::pidTPCEl, aod::pidTOFbeta, aod::TracksExtra>> const& tracks)
  {
	  CommonProcess(tracks,histos,2,2);
  }
};
...
struct r2p24pr {
  ...
  void process(soa::Filtered<soa::Join<aod::Collisions, aod::EvSels>>::iterator const& filteredCollisions, soa::Filtered<soa::Join<aod::Tracks, aod::TrackSelection, aod::pidTPCPi, aod::pidTOFPi, aod::pidTPCPr, aod::pidTOFPr, aod::pidTPCKa, aod::pidTOFKa, aod::pidTPCEl, aod::pidTOFbeta, aod::TracksExtra>> const& tracks)
  {
	  CommonProcess(tracks,histos,3,3);
  }
};
...
struct r2p24pik {
  ...
  void process(soa::Filtered<soa::Join<aod::Collisions, aod::EvSels>>::iterator const& filteredCollisions, soa::Filtered<soa::Join<aod::Tracks, aod::TrackSelection, aod::pidTPCPi, aod::pidTOFPi, aod::pidTPCPr, aod::pidTOFPr, aod::pidTPCKa, aod::pidTOFKa, aod::pidTPCEl, aod::pidTOFbeta, aod::TracksExtra>> const& tracks)
  {
	  CommonProcess(tracks,histos,1,2);
  }
};
...
struct r2p24pip {
  ...
  void process(soa::Filtered<soa::Join<aod::Collisions, aod::EvSels>>::iterator const& filteredCollisions, soa::Filtered<soa::Join<aod::Tracks, aod::TrackSelection, aod::pidTPCPi, aod::pidTOFPi, aod::pidTPCPr, aod::pidTOFPr, aod::pidTPCKa, aod::pidTOFKa, aod::pidTPCEl, aod::pidTOFbeta, aod::TracksExtra>> const& tracks)
  {
	  CommonProcess(tracks,histos,1,3);
  }
};
...
struct r2p24pk {
  ...
  void process(soa::Filtered<soa::Join<aod::Collisions, aod::EvSels>>::iterator const& filteredCollisions, soa::Filtered<soa::Join<aod::Tracks, aod::TrackSelection, aod::pidTPCPi, aod::pidTOFPi, aod::pidTPCPr, aod::pidTOFPr, aod::pidTPCKa, aod::pidTOFKa, aod::pidTPCEl, aod::pidTOFbeta, aod::TracksExtra>> const& tracks)
  {
	  CommonProcess(tracks,histos,3,2);
  }
};
